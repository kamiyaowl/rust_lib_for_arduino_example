...
cp "./target/thumbv7em-none-eabihf/release/lib$LIB_NAME.a" "$DST_DIR/src/cortex-m4/" # for Cortex-M4F
cp "./target/thumbv7em-none-eabihf/release/lib$LIB_NAME.a" "$DST_DIR/src/cortex-m7/" # for Cortex-M7F
# cp "./target/thumbv7em-none-eabi/release/lib$LIB_NAME.a" "$DST_DIR/src/cortex-m4/" # for Cortex-M4
# cp "./target/thumbv7em-none-eabi/release/lib$LIB_NAME.a" "$DST_DIR/src/cortex-m7/" # for Cortex-M7
